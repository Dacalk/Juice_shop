    ...
    <div className="flex flex-col h-screen w-screen font-sans overflow-hidden">
      ...
      <header className="h-20 bg-[#282828]/80 backdrop-blur-md border-b border-white/5 px-4 flex items-center justify-between shrink-0 shadow-xl z-50 no-print sticky top-0 w-full">
        <div className="flex items-center gap-4 cursor-pointer group">
          <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center text-[#eaf89b] shadow-md border border-white/5 rotate-3 group-hover:rotate-0 transition-all">
            <LayoutDashboard size={22} />
          </div>
          <div>
            <h1 className="text-xl font-black text-white tracking-tight leading-none uppercase">Resto POS</h1>
